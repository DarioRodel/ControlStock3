    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('admin', 'Administrador'), ('gestor', 'Gestor de categorías'), ('ventas', 'Equipo de Ventas')], default='ventas', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opcion', models.ForeignKey(default=34, on_delete=django.db.models.deletion.CASCADE, to='control.opcionatributo')),
        ...
        migrations.AddField(
            model_name='producto',
            name='ubicacion',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='control.ubicacion'),
        ),
        migrations.CreateModel(
